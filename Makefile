...
all : sansos.iso
qemu : sansos.iso
	qemu-system-i386 -cdrom sansos.iso -s
usb : sansos.iso
...
kernel.o : kernel/kernel.c
	i686-elf-gcc -c $< -o $@ -ffreestanding -O0 -Wall -Wextra -std=gnu99

sansos.bin : kernel.o boot.o linker.ld
	i686-elf-gcc -T linker.ld -o $@ -ffreestanding -O0 -nostdlib boot.o kernel.o -lgcc
